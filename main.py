...
if __name__ == '__main__':
    ...
    world.add_object(Sphere(Vertex(-5, 0, 15), 1, BaseObject.BLUE, False))
    world.add_object(Sphere(Vertex(0, 0, 15), 2, BaseObject.BLUE, False, BaseObject.REFLECTIVE))
    world.add_object(Sphere(Vertex(7, 0, 17), 4, BaseObject.ORANGE, True))
    world.add_object(Sphere(Vertex(-3, 5, 15), 2, BaseObject.GREEN, True))
